...
const DewScreen = () => {
  ...
  const [nhietDo, setNhietDo] = useState('30');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        <View style={{ width: '100%', height: 50, borderRadius: 20, backgroundColor: Colors.icon, padding: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <Text style={{ color: 'black', fontSize: 20, fontWeight: 'bold' }}>Nhiệt độ tối đa</Text>
          <View>
            <TextInput onChangeText={
              (text) => setNhietDo(text)
            } value={nhietDo} style={{ fontSize: 20, fontWeight: 'bold' }} />
            <Text style={{ fontSize: 12 }}>độ C</Text>
          </View>
        </View>
